...
from cinder.volume.drivers.netapp.iscsi import dfm_opts
from cinder.volume.drivers.netapp.iscsi import NetAppISCSIDriver
...
def create_configuration():
    ...
    configuration.append_config_values(dfm_opts)
...
class NetAppDriverTestCase(test.TestCase):
    ...
    def setUp(self):
        ...
        driver = NetAppISCSIDriver(configuration=create_configuration())
